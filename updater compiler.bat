...
python -m PyInstaller --noconfirm --onefile --console --icon "C:\Users\%username%\Documents\GitHub\Infinite-Parkour-datapack-updater\pack.ico"  "C:\Users\%username%\Documents\GitHub\Infinite-Parkour-datapack-updater\packupdater.py"
